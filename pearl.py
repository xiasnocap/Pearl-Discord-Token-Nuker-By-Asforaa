# NzA5NDk0ODEyNTIwMzQ5NzI0.Xu0B-A.Vl9tFhiNfWL1CCLa6YvxaoKo8f8
...
print(custom_fig.renderText('Pearl.'))
...
# @bot.command()
# async def spam_s(ctx, times: int=200):    
#     for i in range(times):
#         await bot.create_guild('hacked by my ass', region=None, icon=None)
#         print('1 useless server created')
